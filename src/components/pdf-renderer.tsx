...
import { ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Loader2, RotateCw, Search } from "lucide-react";
...
import PdfFullscreen from "@/components/pdf-full-screen";
...
const PdfRenderer = ({ url }: PdfRendererProps) => {
  ...
  // convert CustomPageValidator into a type
      ...
      <div className="flex-1 w-full max-h-screen">
        <SimpleBar autoHide={false} className="max-h-[calc(100vh-10rem)]">
          <div ref={ref}>
            ...
            >
              {/* keep the old one while the new one is loading -> avoid flashing screen in slow devices */}
